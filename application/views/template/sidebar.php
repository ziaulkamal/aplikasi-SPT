  ...
  <div class="main-navbar">
    ...
    <div id="mainnav">
      <ul class="nav-menu custom-scrollbar">
        ...
        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="airplay"></i><span>Bantuan Sosial</span></a>
          <ul class="nav-submenu menu-content">
            <li><a href="#">Buat Surat</a></li>
            <li><a href="#">Daftar Surat</a></li>
          </ul>
        </li>
        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Akta Jual Beli</span></a>
          <ul class="nav-submenu menu-content">
